...
const DocumentLibrary = ({
  ...
  const filteredDocuments = documents.filter(doc => doc.name.toLowerCase().includes(searchTerm.toLowerCase()) || doc.folder.toLowerCase().includes(searchTerm.toLowerCase()));
  return <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {filteredDocuments.map(doc => <div key={doc.id} className="p-4 border border-gray-200 rounded-xl bg-gray-50 hover:bg-white hover:shadow-md transition-all duration-200">
