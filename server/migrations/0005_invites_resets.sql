...
--> statement-breakpoint
ALTER TABLE "clients" ADD COLUMN "deactivated_at" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "clients" ADD COLUMN "password_changed_at" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "providers" ADD COLUMN "deactivated_at" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "providers" ADD COLUMN "password_changed_at" timestamp with time zone;--> statement-breakpoint
...
CREATE INDEX "password_resets_user_idx" ON "password_resets" USING btree ("user_kind","user_id");